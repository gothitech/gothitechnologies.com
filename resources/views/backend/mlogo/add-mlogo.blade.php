          ...
          <section class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Add MLogo
                 <a class="btn btn-success float-right btn-sm" href="{{ route('mlogos.view')}}"><i class="fa fa-list"></i> Logo List</a>
                </h3>
              </div><!-- /.card-body -->
              <div class="card-body">
              	<form method="post" action="{{ route('mlogos.store')}}" id="myForm" enctype="multipart/form-data">
              		@csrf
              		<div class="form-row">
