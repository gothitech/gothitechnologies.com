          ...
          <section class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Add DesktopPortfolio
                 <a class="btn btn-success float-right btn-sm" href="{{ route('desktopportfolio.view')}}"><i class="fa fa-list"></i> DesktopPortfolio List</a>
                </h3>
              </div><!-- /.card-body -->
              <div class="card-body">
              	<form method="post" action="{{ route('desktopportfolio.store')}}" id="myForm" enctype="multipart/form-data">
              		@csrf
              		<div class="form-row">
