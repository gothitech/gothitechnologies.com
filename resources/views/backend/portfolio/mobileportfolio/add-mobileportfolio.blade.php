          ...
          <section class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Add mobilePortfolio
                 <a class="btn btn-success float-right btn-sm" href="{{ route('mobileportfolio.view')}}"><i class="fa fa-list"></i> mobilePortfolio List</a>
                </h3>
              </div><!-- /.card-body -->
              <div class="card-body">
              	<form method="post" action="{{ route('mobileportfolio.store')}}" id="myForm" enctype="multipart/form-data">
              		@csrf
              		<div class="form-row">
